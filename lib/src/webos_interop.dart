...
extension type JSDeviceInfo._(JSObject _) implements JSObject {
  ...
  @JS('versionDot')
  external int versionDot;
  @JS('sdkVersion')
  external String sdkVersion;
  @JS('screenWidth')
  external double screenWidth;
  @JS('screenHeight')
  external double screenHeight;
  @JS('uhd')
  external bool uhd;
  @JS('uhd8k')
  external bool uhd8k;
  ...
  external bool? oled;
  @JS('ddrSize')
  external String? ddrSize;
  @JS('hdr10')
  external bool hdr10;
  @JS('dolbyVision')
  external bool dolbyVision;
  @JS('dolbyAtmos')
  external bool dolbyAtmos;
  @JS('brandName')
  external String brandName;
  @JS('manufacturer')
  external String manufacturer;
  @JS('mainboardMaker')
  external String? mainboardMaker;
  @JS('platformBizType')
  external String platformBizType;
  @JS('tuner')
  external String tuner;
}
